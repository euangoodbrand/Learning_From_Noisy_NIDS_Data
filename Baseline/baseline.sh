...
do
  ...
  do
    CUDA_LAUNCH_BLOCKING=1 python baseline.py --dataset CIC_IDS_2017_test --model_type ${model_type} --data_augmentation none --noise_rate 0.0 --seed ${seed} --num_workers ${num_workers} --result_dir results/trial_${seed}/
