...
do
  ...
  do
    ...
    #     CUDA_LAUNCH_BLOCKING=1 python bootstrapping.py --dataset CIC_IDS_2017 --model_type ${model_type} --data_augmentation ${data_augmentation} --noise_rate ${noise_rate} --noise_type ${noise_type} --imbalance_ratio ${imbalance_ratio} --seed ${seed} --num_workers ${num_workers} --result_dir ${result_dir}results/experiment_1$
    ...
    #     for noise_type in "${noise_types[@]}"; do
    #       for imbalance_ratio in "${imbalance_ratios[@]}"; do
    #         CUDA_LAUNCH_BLOCKING=1 python bootstrapping.py --dataset windows_pe_real --model_type ${model_type} --weight_resampling ${weight_resampling} --noise_rate ${noise_rate} --noise_type ${noise_type} --imbalance_ratio ${imbalance_ratio} --seed ${seed} --num_workers ${num_workers} --result_dir results/experiment_8$
    #       done
    #     done
    #   done
    # done
    ...
    for feature_add_noise_level in "${feature_add_noise_levels[@]}"; do
      CUDA_LAUNCH_BLOCKING=1 python bootstrapping.py --dataset windows_pe_real --model_type ${model_type} --feature_add_noise_level ${feature_add_noise_level} --seed ${seed} --num_workers ${num_workers} --result_dir results/experiment_9$
    done

    # Experiment 10 bootstrapping, feature multiplicative noise
    for feature_mult_noise_level in "${feature_mult_noise_levels[@]}"; do
      CUDA_LAUNCH_BLOCKING=1 python bootstrapping.py --dataset windows_pe_real --model_type ${model_type} --feature_mult_noise_level ${feature_mult_noise_level} --seed ${seed} --num_workers ${num_workers} --result_dir results/experiment_10$
    done

    # Experiment 11 bootstrapping, feature additive and multiplicative noise combinations
    for feature_add_noise_level in "${feature_add_noise_levels[@]}"; do
      for feature_mult_noise_level in "${feature_mult_noise_levels[@]}"; do
        CUDA_LAUNCH_BLOCKING=1 python bootstrapping.py --dataset windows_pe_real --model_type ${model_type} --feature_add_noise_level ${feature_add_noise_level} --feature_mult_noise_level ${feature_mult_noise_level} --seed ${seed} --num_workers ${num_workers} --result_dir results/experiment_11$
      done
    done
    ...
    for noise_rate in "${noise_rates[@]}"; do
      for feature_add_noise_level in "${feature_add_noise_levels[@]}"; do
        CUDA_LAUNCH_BLOCKING=1 python bootstrapping.py --dataset windows_pe_real --model_type ${model_type} --noise_rate ${noise_rate} --feature_add_noise_level ${feature_add_noise_level} --seed ${seed} --num_workers ${num_workers} --result_dir results/experiment_12$
      done
    done
    ...
    for noise_rate in "${noise_rates[@]}"; do
      for feature_mult_noise_level in "${feature_mult_noise_levels[@]}"; do
        CUDA_LAUNCH_BLOCKING=1 python bootstrapping.py --dataset windows_pe_real --model_type ${model_type} --noise_rate ${noise_rate} --feature_mult_noise_level ${feature_mult_noise_level} --seed ${seed} --num_workers ${num_workers} --result_dir results/experiment_13$
      done
    done
