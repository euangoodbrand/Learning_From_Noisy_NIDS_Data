...
do
  ...
  do
    # Experiment 1: Just Label Noise with Naive Reweighting
    for noise_rate in "${noise_rates[@]}"; do
      CUDA_LAUNCH_BLOCKING=1 python baseline.py \
        ...
        --result_dir results/final_experiments/exp1_label_noise_naive_reweighting
    done

    # Experiment 2: Label Noise and Imbalance with Naive Reweighting
    for noise_rate in "${noise_rates[@]}"; do
    ...
    # # Experiment 3: Feature Noise, Label Noise, and Imbalance with Naive Reweighting
    # for noise_rate in "${noise_rates[@]}"; do
    #   for imbalance_ratio in "${imbalance_ratios[@]}"; do
