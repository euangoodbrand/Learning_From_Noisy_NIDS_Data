...
for seed in 1; do #2 3 4 5
    for model_type in likelihoodRatioTest; do
        ...
        #     CUDA_LAUNCH_BLOCKING=1 python likelihoodRatioTest.py --dataset windows_pe_real --model_type ${model_type} --data_augmentation none --noise_rate 0 --imbalance_ratio 0 --seed ${seed} --num_workers ${num_workers} --feature_add_noise_level ${add_noise_level} --result_dir results/experiment_9$
        # done

        # # Experiment 10: Multiplicative noise
        # for mult_noise_level in "${multiplicative_noise_levels[@]}"; do
        #     CUDA_LAUNCH_BLOCKING=1 python likelihoodRatioTest.py --dataset windows_pe_real --model_type ${model_type} --data_augmentation none --noise_rate 0 --imbalance_ratio 0 --seed ${seed} --num_workers ${num_workers} --feature_mult_noise_level ${mult_noise_level} --result_dir results/experiment_10$
        # done

        # # Experiment 11: Combination of additive and multiplicative noise
        # for add_noise_level in "${additive_noise_levels[@]}"; do
        #     for mult_noise_level in "${multiplicative_noise_levels[@]}"; do
        #         CUDA_LAUNCH_BLOCKING=1 python likelihoodRatioTest.py --dataset windows_pe_real --model_type ${model_type} --data_augmentation none --noise_rate 0 --imbalance_ratio 0 --seed ${seed} --num_workers ${num_workers} --feature_add_noise_level ${add_noise_level} --feature_mult_noise_level ${mult_noise_level} --result_dir results/experiment_11$
        #     done
        # done
        ...
        # for noise_rate in "${noise_rates[@]}"; do
        #     for add_noise_level in "${additive_noise_levels[@]}"; do
        #         CUDA_LAUNCH_BLOCKING=1 python likelihoodRatioTest.py --dataset windows_pe_real --model_type ${model_type} --data_augmentation none --noise_rate ${noise_rate} --noise_type uniform --imbalance_ratio 0 --seed ${seed} --num_workers ${num_workers} --feature_add_noise_level ${add_noise_level} --result_dir results/experiment_12$
        #     done
        # done
        ...
        # for noise_rate in "${noise_rates[@]}"; do
        #     for mult_noise_level in "${multiplicative_noise_levels[@]}"; do
        #         CUDA_LAUNCH_BLOCKING=1 python likelihoodRatioTest.py --dataset windows_pe_real --model_type ${model_type} --data_augmentation none --noise_rate ${noise_rate} --noise_type uniform --imbalance_ratio 0 --seed ${seed} --num_workers ${num_workers} --feature_mult_noise_level ${mult_noise_level} --result_dir results/experiment_13$
        #     done
        # done

        # # Experiment 14: Additive noise with L2 regularization
        # for add_noise_level in "${additive_noise_levels[@]}"; do
        #     CUDA_LAUNCH_BLOCKING=1 python likelihoodRatioTest.py --dataset windows_pe_real --model_type ${model_type} --data_augmentation none --noise_rate 0 --imbalance_ratio 0 --seed ${seed} --num_workers ${num_workers} --feature_add_noise_level ${add_noise_level} --weight_decay 0.01 --result_dir results/experiment_14$
        # done

        # # Experiment 15: Multiplicative noise with L2 regularization
        # for mult_noise_level in "${multiplicative_noise_levels[@]}"; do
        #     CUDA_LAUNCH_BLOCKING=1 python likelihoodRatioTest.py --dataset windows_pe_real --model_type ${model_type} --data_augmentation none --noise_rate 0 --imbalance_ratio 0 --seed ${seed} --num_workers ${num_workers} --feature_mult_noise_level ${mult_noise_level} --weight_decay 0.01 --result_dir results/experiment_15$
        # done
